original_lexicon = ["absence of ,pre,neg", "adequate to rule her out ,pre,neg","adequate to rule him out ,pre,neg","adequate to rule out ,pre,neg","adequate to rule the patient out ,pre,neg","although ,termin,neg","any other,pre,neg","apart from ,termin,neg","are ruled out ,post,neg","as a cause for ,termin,neg","as a cause of ,termin,neg","as a etiology for ,termin,neg","as a etiology of ,termin,neg","as a reason for ,termin,neg","as a reason of ,termin,neg","as a secondary cause for ,termin,neg","as a secondary cause of ,termin,neg","as a secondary etiology for ,termin,neg","as a secondary etiology of ,termin,neg","as a secondary origin for ,termin,neg","as a secondary origin of ,termin,neg","as a secondary reason for ,termin,neg","as a secondary reason of ,termin,neg","as a secondary source for ,termin,neg","as a secondary source of ,termin,neg","as a source for ,termin,neg","as a source of ,termin,neg","as an cause for ,termin,neg","as an cause of ,termin,neg","as an etiology for ,termin,neg","as an etiology of ,termin,neg","as an origin for ,termin,neg","as an origin of ,termin,neg","as an reason for ,termin,neg","as an reason of ,termin,neg","as an secondary cause for ,termin,neg","as an secondary cause of ,termin,neg","as an secondary etiology for ,termin,neg","as an secondary etiology of ,termin,neg","as an secondary origin for ,termin,neg","as an secondary origin of ,termin,neg","as an secondary reason for ,termin,neg","as an secondary reason of ,termin,neg","as an secondary source for ,termin,neg","as an secondary source of ,termin,neg","as an source for ,termin,neg","as an source of ,termin,neg","as has,termin,neg","as needed,pre,hypo","as the cause for ,termin,neg","as the cause of ,termin,neg","as the etiology for ,termin,neg","as the etiology of ,termin,neg","as the origin for ,termin,neg","as the origin of ,termin,neg","as the reason for ,termin,neg","as the reason of ,termin,neg","as the secondary cause for ,termin,neg","as the secondary cause of ,termin,neg","as the secondary etiology for ,termin,neg","as the secondary etiology of ,termin,neg","as the secondary origin for ,termin,neg","as the secondary origin of ,termin,neg","as the secondary reason for ,termin,neg","as the secondary reason of ,termin,neg","as the secondary source for ,termin,neg","as the secondary source of ,termin,neg","as the source for ,termin,neg","as the source of ,termin,neg","as well as any,pre,neg","aside from ,termin,neg","aunt,pre,exp","aunt's,pre,exp","be ruled out ,post,poss","be ruled out for ,pre,poss","because,termin,hypo","being ruled out ,post,poss","brother,pre,exp","brother's,pre,exp","but ,termin,neg","can be ruled out ,post,poss","can be ruled out for ,pre,poss","can rule her out ,pre,neg","can rule her out against ,pre,neg","can rule her out for ,pre,neg","can rule him out ,pre,neg","can rule him out against ,pre,neg","can rule him out for ,pre,neg","can rule out ,pre,neg","can rule out against ,pre,neg","can rule out for ,pre,neg","can rule the patient out ,pre,neg","can rule the patinet out against ,pre,neg","can rule the patinet out for ,pre,neg","cannot ,pre,neg","cause for ,termin,neg","cause of ,termin,neg","causes for ,termin,neg","causes of ,termin,neg","checked for ,pre,neg","clear of,pre,neg","come back for,pre,hypo","come back to,pre,hypo","complains,termin,histexp","could be ruled out ,post,poss","could be ruled out for ,pre,poss","currently,termin,histexp","dad,pre,exp","dad's,pre,exp","declined ,pre,neg","declines ,pre,neg","denied ,pre,neg","denies ,pre,neg","denying ,pre,neg","did not rule out ,post,poss","did rule her out ,pre,neg","did rule her out against ,pre,neg","did rule her out for ,pre,neg","did rule him out ,pre,neg","did rule him out against ,pre,neg","did rule him out for ,pre,neg","did rule out ,pre,neg","did rule out against ,pre,neg","did rule out for ,pre,neg","did rule the patient out ,pre,neg","did rule the patient out against ,pre,neg","did rule the patient out for ,pre,neg","doesn't look like,pre,neg","ED,termin,hist","emergency department,termin,hist","etiology for ,termin,neg","etiology of ,termin,neg","evaluate for ,pre,neg","except ,termin,neg","fails to reveal ,pre,neg",
			...
			"history,pre,hist","history and,pseudo,hist","history and examination,pseudo,hist","history and physical,pseudo,hist","history for,pseudo,hist","history of chief complaint,pseudo,hist","history of present illness,pseudo,hist","history taking,pseudo,hist","however ,termin,neg","if,pre,hypo",
...
labels = {'poss': "AMBIVALENT_EXISTENCE", 'hypoexp':"PSEUDOHYPO", 'neg': "DEFINITE_NEGATED_EXISTENCE", 'histexp': "PSEUDOHIST", 'hist': "HISTORICAL", 'hypo': "HYPOTHETICAL"}
directions = {"pseudo": "forwards",  'post':  "backward", 'termin': "terminate", 'pre': "forward"}

import json

outfile = open("original_context_lexicon.jsonl", "w+")
for lex in original_lexicon:

    match, position, label = lex.split(",")

    if label == "exp":
        continue
    json_dict = {}

    json_dict["name"] = match
    if position == "pseudo" and label =="neg":
        json_dict["label"] = "PSEUDONEG"
    elif position == "pseudo" and label =="hist":
        json_dict["label"] = "PSEUDOHIST"
    elif position == "pseudo" and label =="hypo":
        json_dict["label"] = "PSEUDOHIST"

    else:
        json_dict["label"] = labels[label]
    json_dict["direction"] = directions[position]
    json_dict["regex"] = None
    json_dict["spacy_match"] = [{"LOWER": word} for word in match.strip(" ").split(" ")]
